 ...
 var GameBox = React.createClass({
  ...
  var filteredmessage = function (rawtext,level){
    ...
    for (var x = 0; x < splittextarray.length; x++){
        if ((splittextarray[x].substring(0, 7) == "http://") || (splittextarray[x].substring(0, 8) == "https://") || (splittextarray[x].substring(0, 3) == "ID:")){
            if (x > 0){
              for (var y = 0; y < x; y++){
            ...
            }else if((level >= 2)||(splittextarray[x].substring(0, 3) == "ID:")){
      ...
      el.div(
        ...
        el.div({className: 'panel-body'},
          ...
          el.div({className:'h6', style:{fontWeight:'bold'}},
            (faucettimeout == 300) ? 'Ready to Claim' : 'You Must Wait: ' + faucettimeout.toString() + ' Seconds to Claim Again'
          ...
          el.div(
            ...
            el.div({className:'row'},
              el.div({className:'col-xs-4'},
                el.span(
                  {style: { fontWeight: 'bold',marginTop: '-25px' }},
                  '24 Hour Wager: ' + helpers.commafy(helpers.convSatstoCointype(worldStore.state.user.wager24hour).toString()) + ' ' + worldStore.state.coin_type
                )
              )
            ),
            el.div(null,
